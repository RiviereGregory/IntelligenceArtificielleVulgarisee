...
classes = ["Un T-shirt/haut", "Un pantalon", "Un pull", "Une robe", "Un manteau", "Une sandale", "Une chemise",
           "Une baskets", "Un sac", "Une botte de cheville"]
...
image = Image.open("images/IMG_5.jpg").convert('L')
...
print()
print("Selon moi l'image est : " + classes[classes_x[0]])
print()
...
for classe in classes:
    print(classe + ": " + str((prediction[0][i] * 100)) + "%")
    i = i + 1
